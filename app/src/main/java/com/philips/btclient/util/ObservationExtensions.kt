...
import com.philips.btclient.acom.Observation.Companion.CODE_SYSTEM_OBSERVATRION_CATEGORY_URL
import com.philips.btclient.acom.Observation.Companion.MDC_SYSTEM_URN_STRING
import com.philips.btclient.acom.ObservationValue
...
import com.philips.btclient.toUINT8
        ...
        putJsonObject("code") {
            putJsonArray("coding") {
                addJsonObject {
                    ...
                    put("code", "${unitCodeEnum.value}")
                    put("display", unitCodeEnum.description)
                }
            }
        }
